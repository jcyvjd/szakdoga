...
const HowToUse = () => (
    <div className='h-full overflow-auto no-scrollbar'>
        ...
        <p className='mt-2'>
            ...
            and to confirm your password you have to type it in again in the "Confirm Password" input area. Once you have done that, you will be automatically logged in with your new account.
            Note that you will be logged in automatically if you were previously logged in and closed the page without signing out. This will only apply
            if you are using the same browser and device; and you logged in in the past 3 days.
        </p>

        <h2 className='text-2xl font-bold mt-4'>Log out</h2>
        <p className='mt-2'>
        ...
        <h2 className='text-2xl font-bold mt-4'>Inside a Room</h2>
        <h3 className='text-xl font-bold mt-2'>Left side</h3>
        <p className='mt-2'>
            ...
            Please don't leave in the middle of a game, as it will affect the other users' experience / gameplay. 
        ...
        <h3 className='text-xl font-bold mt-4'>Right side</h3>
        <p className='mt-2'>
